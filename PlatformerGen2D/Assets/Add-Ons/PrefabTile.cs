...
public class PrefabTile : UnityEngine.Tilemaps.TileBase
{
    ...
    public float PrefabLocalOffsetX = 0.5f;
    public float PrefabLocalOffsetY = 0.5f;
    ...
    public override bool StartUp(Vector3Int position, ITilemap tilemap, GameObject go)
    {
        ...
        if (go != null)
        {
            ...
            go.transform.position = new Vector3(position.x + PrefabLocalOffsetX
                , position.y + PrefabLocalOffsetY
                , prefabZOffset);
